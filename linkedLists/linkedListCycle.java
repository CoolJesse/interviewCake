...
/*********************************** Solution using a HashSet *****************************************/
    ...
    public static boolean containsCycle(LinkedListNode firstNode) {
		...
		for(LinkedListNode currentNode = firstNode; currentNode != null; currentNode = currentNode.next){
			if(record.contains(currentNode.value))
				return true;

			record.add(currentNode.value);
		}

        return false;
    }
    */
/********************************* Solution using pointer chasing ************************************/
public static boolean containsCycle(LinkedListNode firstNode) {
    ...
    LinkedListNode slowRunner = firstNode, fastRunner = firstNode;
